...
<div class="container-md mt-3 p-3">
    <table class="table table-hover border shadow">
        ...
        <tbody id="class-attendance">
            ...
            $i = 1;
$classEnded = false; // Replace this with the actual logic to determine if the class has ended
...
foreach ($studentList as $student) {
    ...
    echo "<td>
            <div class='form-check form-check-inline'>
                <input type='radio' class='form-check-input' id='std-" . $student[3] . "-present' name='std-" . $student[3] . "' value='1' " . (($student[4] == 1) ? "checked" : "") . ($classEnded ? " disabled" : "") . ">
                <label class='form-check-label' for='std-" . $student[3] . "-present'><span class='badge text-bg-success'>Present</span></label>
            </div>
            <div class='form-check form-check-inline'>
                <input type='radio' class='form-check-input' id='std-" . $student[3] . "-late' name='std-" . $student[3] . "' value='2' " . (($student[4] == 2) ? "checked" : "") . ($classEnded ? " disabled" : "") . ">
                <label class='form-check-label' for='std-" . $student[3] . "-late'><span class='badge text-bg-warning'>Late</span></label>
            </div>
            <div class='form-check form-check-inline'>
                <input type='radio' class='form-check-input' id='std-" . $student[3] . "-absent' name='std-" . $student[3] . "' value='0' " . (($student[4] == 0) ? "checked" : "") . ($classEnded ? " disabled" : "") . ">
    ...
    echo "<td>
            ...
            data-user-name='" . $student[1] . "' 
            data-user-index='" . $student[2] . "' 
            data-user-reg='" . $student[0] . "'>Remove</button>
        </td>";
    echo "</tr>";
}
