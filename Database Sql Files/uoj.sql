...
(66, 1, 2, '2024-11-04', '14:09:00', '14:13:00'),
(67, 2, 1, '2024-11-04', '14:33:00', '15:33:00'),
(68, 2, 1, '2024-11-05', '19:59:00', '20:05:00'),
(69, 1, 1, '2024-11-05', '20:03:00', '20:07:00'),
(70, 1, 2, '2024-11-05', '20:12:00', '20:15:00'),
(71, 1, 2, '2024-11-05', '21:02:00', '21:52:00'),
(72, 1, 1, '2024-11-05', '23:10:00', '23:16:00'),
(73, 1, 1, '2024-11-05', '23:10:00', '23:16:00'),
(74, 2, 1, '2024-11-06', '00:44:00', '00:50:00'),
(75, 1, 2, '2024-11-06', '00:52:00', '01:05:00'),
(76, 2, 1, '2024-11-06', '00:57:00', '01:03:00'),
(77, 1, 2, '2024-11-06', '01:16:00', '01:19:00'),
(78, 1, 2, '2024-11-06', '21:20:00', '21:24:00'),
(79, 2, 1, '2024-11-06', '21:56:00', '22:02:00'),
(80, 1, 3, '2024-11-07', '15:15:00', '15:20:00'),
(81, 1, 2, '2024-11-07', '15:26:00', '15:30:00'),
(82, 2, 1, '2024-11-07', '19:34:00', '19:39:00'),
(83, 2, 1, '2024-11-07', '22:36:00', '22:40:00'),
(84, 1, 1, '2024-11-07', '22:38:00', '22:41:00'),
(85, 1, 2, '2024-11-07', '22:40:00', '22:44:00'),
(86, 4, 2, '2024-11-07', '23:01:00', '23:05:00'),
(87, 1, 1, '2024-11-07', '23:01:00', '23:05:00'),
(88, 2, 1, '2024-11-08', '12:55:00', '13:00:00'),
(90, 1, 2, '2024-11-08', '12:58:00', '13:04:00'),
(91, 1, 3, '2024-11-08', '13:00:00', '13:05:00'),
(92, 2, 1, '2024-11-08', '13:40:00', '13:45:00'),
(93, 2, 1, '2024-11-08', '13:51:00', '13:56:00'),
(94, 1, 1, '2024-11-08', '13:56:00', '14:01:00'),
(95, 2, 1, '2024-11-08', '15:04:00', '15:08:00'),
(96, 2, 1, '2024-11-08', '15:04:00', '15:08:00'),
(97, 2, 1, '2024-11-08', '15:05:00', '15:13:00'),
(98, 2, 1, '2024-11-08', '15:05:00', '15:10:00'),
(99, 1, 3, '2024-11-15', '15:09:00', '15:12:00');
...
--
-- Table structure for table `uoj_instructor`
--

CREATE TABLE `uoj_instructor` (
  `instructor_id` int(11) NOT NULL,
  `instructor_nic` varchar(12) NOT NULL,
  `instructor_name` varchar(255) NOT NULL,
  `instructor_mobile` char(10) NOT NULL,
  `instructor_email` varchar(30) DEFAULT NULL,
  `instructor_gender` tinyint(1) DEFAULT NULL,
  `instructor_address` varchar(50) DEFAULT NULL,
  `instructor_profile_pic` varchar(255) DEFAULT NULL,
...
(5, '123456788765', 'inssssstruct', '1234567887', 'instruct@gmail.com', 0, 'sdhgfjdshfj', NULL, 13);
...
(9, 's 34589', 'chrismika chrismika', 0, '47', '123456788765', '2024-11-06', '2024-11-01', 'jaffna jaffna', 'gampaha', '1234567887', '6666666666', 'chris@gmail.com', NULL, NULL, 14, 0),
(10, 's 66789', 'imshan ', 0, '47', '123456788765', '2004-07-09', '2024-10-30', 'jaffna jaffna', 'kkdfhvjdfhvh', '4556465441', '0011445566', 'dhufu@gmail.com', NULL, '2', 15, 9);
...
(1, 'admin123', '$2y$10$STwe92fSGRzxnzvAvHhVfu0smQ4rzSRP/0YlOIBDi5ctCdXztMWWC', '42a5526e83a75a12e3d7b61ee95c7a7a', 1, 0, 0, ''),
(2, 'lec001', '$2y$10$rWNM/kdbt.HgkZfFLYWy6es3GQwIxrAP2b5hSze0Zp0i58VBHguCW', '354b27cd6bfc86f04faebbb16d2193d3', 1, 1, 0, ''),
(3, '2020csc056', '$2y$10$bhfWho37QjpkUYmLzPh9fOYJifg8h2wdVt7KwoJXUTDtnes9TT7/K', 'd1daa5555e0f02469638762c702f9e31', 1, 3, 0, ''),
(4, 'instruct1', '$2y$10$X3Du0iyJDHbFo5cSu5BSKusCgOdGH0VufDh0drDgFyjWMciQ.R.Pu', '00cf48f1221c9462d210336cca0297eb', 1, 2, 0, ''),
...
(12, '2020csc080', '$2y$10$h/TOajufsiIkbdsYf6VEPu265kwCH/DGGndnG3d9azF7ZkXrhC14a', 'a4e7189841ec61829debf13bb363b9e9', 1, 3, 1, ''),
(13, '2019csc078', '$2y$10$AhBMONDJyFrwB5UkLv.4D.TDLmhhD1pQ4qgvQoVViwZfdhghSsRza', 'e71ce770ef2e021b95fb80f04ea57d2d', 2, 2, 0, ''),
(14, '2020csc065', '$2y$10$evoe.mVSe24jVBqepzgYauNk9rOn2Zp.UppaZbFvS7bh3bvVGDrVa', '39e98e930000c5026c909e72e5473977', 2, 3, 0, ''),
(15, '2020csc026', '$2y$10$a8bEMY0FOeDRZnaGmg0mL.dsBg2fdOpk5.kEge74eX71r0.qem4ua', 'e99bfbc24e74decb7475d3ac9fd3009b', 1, 3, 0, '');
...
--
-- Indexes for table `uoj_instructor`
--
ALTER TABLE `uoj_instructor`
  ADD PRIMARY KEY (`instructor_id`,`user_id`),
  ADD UNIQUE KEY `instructor_nic` (`instructor_nic`),
  ADD UNIQUE KEY `instructor_mobile` (`instructor_mobile`),
...
--
ALTER TABLE `uoj_class`
  MODIFY `class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
-- AUTO_INCREMENT for table `uoj_instructor`
--
ALTER TABLE `uoj_instructor`
...
--
ALTER TABLE `uoj_lecturer`
  MODIFY `lecr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Constraints for table `uoj_instructor`
--
ALTER TABLE `uoj_instructor`
  ADD CONSTRAINT `uoj_instructor_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `uoj_user` (`user_id`) ON DELETE CASCADE;
